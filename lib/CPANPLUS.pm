...
# $Revision: #11 $ $Change: 8346 $ $DateTime: 2003/10/05 17:31:32 $
...
BEGIN {
    ...
    @ISA        =   qw( Exporter );
    $VERSION    =   0.045;    #have to hardcode or cpan.org gets unhappy
}
...
This document describes version 0.045 of CPANPLUS, released October 5, 2003.
