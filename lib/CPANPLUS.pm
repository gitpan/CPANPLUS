...
# $Revision: #16 $ $Change: 10877 $ $DateTime: 2004/06/15 20:13:35 $
...
BEGIN {
    ...
    @ISA        =   qw( Exporter );
    $VERSION    =   0.0499;    #have to hardcode or cpan.org gets unhappy
}
...
This document describes version 0.048 of CPANPLUS, released December 12, 2003.
